            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>" aria-label="<?php echo e(__('Register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="phonenumber" class="col-md-4 col-form-label text-md-right"><?php echo e(__('auth.PhoneNumber')); ?></label>

                            <div class="col-md-6">
                                <input id="phonenumber" type="text" class="form-control<?php echo e($errors->has('phonenumber') ? ' is-invalid' : ''); ?>" name="phonenumber" required>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('auth.ConfirmPassword')); ?></label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <button class=" btn btn-primary  btn-danger"  href="<?php echo e(route('home')); ?>"><?php echo e(__('titles.cancel')); ?></button>
