...
<a class="navbar-brand" href="{{ route('home') }}">
    <img src="{{ asset('vendor/logo/SoukElfellah-100px.png')}}" width="100" height="37" alt="logo">
      ...
      <a class="nav-link" href="{{ route('home') }}">{{ __('titles.explore')}}</a>
      ...
      <div class="overlay"> سوق الفلاح هو الحل الأمثل للفلاحين لتسويق منتجاتهم واكتشاف فرص عملٍ جديدة والبحث عن كل ما يحتاجه الفلاح </div>
        <div class="row"> 
          <div class="col-xl-9 mx-auto">
            ...
            <a class="btn  btn-block btn-lg btn-primary" href="{{ route('ad.create') }}">{{ __('auth.AddProduct')}}</a>
            <a class="masthead text-white text-center" href="{{ route('home') }}">{{ __('titles.explore')}}</a>   
          </div>        
          </div>
            ...
            <form>
              <div class="form-row">
                ...
                <div class="col-12 col-md-3">
                 <!-- <button  class="btn btn-block btn-lg btn-primary" href="{{ route('register') }}" >{{ __('auth.Register')}}</button>-->
                </div>
              </div>
            </form>
          </div>
    ...
    <section class="call-to-action text-white text-center">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class=" col-12 col-md-3 mb-5 mx-auto">
            <a class="btn btn-block btn-lg btn-primary" href="{{ route('register') }}">{{ __('auth.Register')}}</a>
            <a class="masthead text-white text-center" href="{{ route('home') }}">{{ __('titles.explore')}}</a>
          </div>     
        </div>
          <!--<div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
