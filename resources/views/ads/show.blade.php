    ...
    <div class="col-lg-7 col-md-6 col-xs-11">
        <div class="card ">
            <div class="card-body">
                ...
                <p class="card-text"> الولاية : {{$ad->wilaya->name_ar}} </p>
                <p class="card-text">السعر:  {{$ad->price}} {{$ad->currency->symbol}}</p>
                <p class="card-text">    الهاتف : {{$ad->user->phoneNumber}} </p>
                <h4>وصف الإعلان</h4>
                <p class="card-text">{{$ad->text}}</p>
             
                <p class="blog-post-meta">{{\Carbon\Carbon::parse($ad->created_at)->diffForHumans()}}  من طرف  </p>
